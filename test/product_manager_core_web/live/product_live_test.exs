defmodule ProductManagerCoreWeb.ProductLiveTest do
  use ProductManagerCoreWeb.ConnCase

  import Phoenix.LiveViewTest
  import ProductManagerCore.CatalogFixtures

  @create_attrs %{name: "some name", description: "some description", stock: 42, amount: "120.5", url_image: "some url_image"}
