defmodule ProductManagerCoreWeb.CategoryLiveTest do
  use ProductManagerCoreWeb.ConnCase

  import Phoenix.LiveViewTest
  import ProductManagerCore.CatalogFixtures

  @create_attrs %{active: true, name: "some name", url_image: "some url_image"}
  @update_attrs %{active: false, name: "some updated name", url_image: "some updated url_image"}
  @invalid_attrs %{active: false, name: nil, url_image: nil}
