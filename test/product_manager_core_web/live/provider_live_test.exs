defmodule ProductManagerCoreWeb.ProviderLiveTest do
  use ProductManagerCoreWeb.ConnCase

  import Phoenix.LiveViewTest
  import ProductManagerCore.CatalogFixtures

  @create_attrs %{active: true, name: "some name", location: "some location", slug: "some slug", telephone: "some telephone", url_contact: "some url_contact", email: "some email", url_image: "some url_image"}
  ...
  @invalid_attrs %{active: false, name: nil, location: nil, slug: nil, telephone: nil, url_contact: nil, email: nil, url_image: nil}
